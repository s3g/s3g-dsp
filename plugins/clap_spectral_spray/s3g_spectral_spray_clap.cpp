...
- (void)drawRect:(NSRect)dirty
{
    ...
    [@"s3g SPECTRAL SPRAY" drawAtPoint:NSMakePoint(18,14) withAttributes:lab];
...
const clap_plugin_descriptor_t descriptor {
    ...
    "",
    "0.1.0",
    "Stereo native C++ FFT spectral spray experiment with bin displacement, spectral memory, freeze, and dry/wet alignment.",
    features
};
