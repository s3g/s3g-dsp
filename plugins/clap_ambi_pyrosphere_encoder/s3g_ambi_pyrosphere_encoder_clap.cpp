...
constexpr const char* portableTitle = "s3g AMBI ENCODER PYROSPHERE";
constexpr const char* portablePresetDirectory = "Ambi Pyrosphere Encoder";
constexpr const char* portablePresetExtension = "s3gpyro";
#define S3G_ENVIRONMENT_KIND 4
struct Plugin;
...
constexpr uint32_t kParamCount = 67u;
...
struct SavedState {
    ...
    s3g::AmbiPyrosphereParams params {};
    uint32_t presetIndex = 0u;
    char customPresetName[64] {};
    PyrosphereSurface surface {};
};
...
struct ControlSnapshot {
    s3g::AmbiPyrosphereParams params {};
    s3g::AmbiPyrosphereParams effectiveParams {};
    PyrosphereSurface surface {};
    uint32_t presetIndex = 0u;
    char customPresetName[64] {};
};
...
struct Plugin {
    ...
    s3g::AmbiPyrosphereEncoder engine {};
    s3g::AmbiPyrosphereParams params {};
    s3g::AmbiPyrosphereParams effectiveParams {};
    PyrosphereSurface surface {};
    ...
    std::array<std::atomic<float>, s3g::kAmbiPyrosphereMaxVoices> guiAzimuth {};
    std::array<std::atomic<float>, s3g::kAmbiPyrosphereMaxVoices> guiElevation {};
    std::array<std::atomic<float>, s3g::kAmbiPyrosphereMaxVoices> guiDistance {};
    std::array<std::atomic<float>, s3g::kAmbiPyrosphereMaxVoices> guiEnergy {};
    std::array<std::atomic<float>, s3g::kAmbiPyrosphereMaxVoices> guiGust {};
    std::array<std::atomic<float>, s3g::kAmbiPyrosphereMaxVoices> guiRenderGain {};
...
void publishInactiveTelemetry(Plugin& instance)
{
    ...
    const uint32_t voices =
        std::min<uint32_t>(p->engine.processingVoiceCount(), s3g::kAmbiPyrosphereMaxVoices);
...
void queueGuiSurface(Plugin& plugin, const PyrosphereSurface& surface)
{
...
void sanitizeStatePayload(s3g::AmbiPyrosphereParams& params,
    PyrosphereSurface& surface)
{
    s3g::AmbiPyrosphereEncoder sanitizer {};
...
bool queueStateCommand(Plugin& plugin,
    s3g::AmbiPyrosphereParams params, PyrosphereSurface surface,
    uint32_t presetIndex, const char* customName, clap_id actionId)
{
    ...
    state.presetIndex = std::min<uint32_t>(presetIndex,
        s3g::kAmbiPyrosphereFactoryPresetCount - 1u);
...
bool saveCustomPresetFile(const char* path,
    const s3g::AmbiPyrosphereParams& params, const char* name)
{
...
bool loadCustomPresetFile(const char* path, CustomPresetFile& file)
{
    ...
    if (ok) {
        const size_t paramsSize = file.version == 10u
            ? offsetof(s3g::AmbiPyrosphereParams, place)
            : (file.version == 11u
                    ? offsetof(s3g::AmbiPyrosphereParams, environmentSize)
                    : (file.version == 12u
                            ? offsetof(s3g::AmbiPyrosphereParams, fieldListenMode)
                            : (file.version == 13u
...
void randomizeSafe(Plugin& plugin)
{
    ...
    p.gustRate = randomLogRange(seed, 0.004f, 1.60f);
    if (randomUnit(seed) < 0.32f) {
        p.wind *= 0.38f;
        p.gustRate = std::max(s3g::kAmbiPyrosphereMinIgnitionRateHz,
            p.gustRate * 0.25f);
    }
    ...
    p.place = randomChoice(seed, s3g::kAmbiPyrospherePlaceCount);
    ...
    p.structuralLoad = standingWood
        ? randomRange(seed, 0.34f, 0.92f) : randomRange(seed, 0.0f, 0.24f);
    p.snap = standingWood
...
bool assignParam(s3g::AmbiPyrosphereParams& params, clap_id id, double value)
{
    switch (id) {
...
s3g::AmbiPyrosphereParams pyrosphereSurfaceParams(
    const Plugin& plugin, float cursorX, float cursorY)
{
    ...
    auto result = nearest;
#define S3G_PYROSPHERE_SURFACE_BLEND(member) \
    result.member = s3g::parameterSurfaceBlend(plugin.surface, weights, \
        [](const s3g::AmbiPyrosphereParams& p) { return p.member; }, base.member)
    S3G_PYROSPHERE_SURFACE_BLEND(wind);
    result.gustRate = s3g::parameterSurfaceBlendLog(
        plugin.surface, weights,
        [](const s3g::AmbiPyrosphereParams& p) { return p.gustRate; },
        base.gustRate, s3g::kAmbiPyrosphereMinIgnitionRateHz);
    S3G_PYROSPHERE_SURFACE_BLEND(gustDepth);
    S3G_PYROSPHERE_SURFACE_BLEND(turbulence);
    S3G_PYROSPHERE_SURFACE_BLEND(flutter);
    S3G_PYROSPHERE_SURFACE_BLEND(material);
    S3G_PYROSPHERE_SURFACE_BLEND(air);
    ...
    S3G_PYROSPHERE_SURFACE_BLEND(shrill);
    S3G_PYROSPHERE_SURFACE_BLEND(body);
    S3G_PYROSPHERE_SURFACE_BLEND(breath);
    S3G_PYROSPHERE_SURFACE_BLEND(grit);
    S3G_PYROSPHERE_SURFACE_BLEND(field);
    S3G_PYROSPHERE_SURFACE_BLEND(motionRateHz);
    S3G_PYROSPHERE_SURFACE_BLEND(motionFlow);
    S3G_PYROSPHERE_SURFACE_BLEND(motionShear);
    S3G_PYROSPHERE_SURFACE_BLEND(motionCurl);
    S3G_PYROSPHERE_SURFACE_BLEND(motionUpdraft);
    result.centerAzimuthDeg = s3g::parameterSurfaceBlendAngleDegrees(
        plugin.surface, weights,
        [](const s3g::AmbiPyrosphereParams& p) { return p.centerAzimuthDeg; },
        base.centerAzimuthDeg);
    S3G_PYROSPHERE_SURFACE_BLEND(centerElevationDeg);
    S3G_PYROSPHERE_SURFACE_BLEND(centerDistance);
    S3G_PYROSPHERE_SURFACE_BLEND(spatialFollow);
    S3G_PYROSPHERE_SURFACE_BLEND(space);
    S3G_PYROSPHERE_SURFACE_BLEND(environmentSize);
    S3G_PYROSPHERE_SURFACE_BLEND(environmentDecay);
    S3G_PYROSPHERE_SURFACE_BLEND(environmentDamping);
    S3G_PYROSPHERE_SURFACE_BLEND(fieldListenAmount);
    S3G_PYROSPHERE_SURFACE_BLEND(particles);
    S3G_PYROSPHERE_SURFACE_BLEND(vortex);
    S3G_PYROSPHERE_SURFACE_BLEND(pressure);
...
s3g::AmbiPyrosphereParams pyrosphereSurfaceParams(const Plugin& plugin)
{
    if (!plugin.active.load(std::memory_order_acquire)) {
        return pyrosphereSurfaceParams(
            plugin, plugin.params.surfaceX, plugin.params.surfaceY);
    }
    return pyrosphereSurfaceParams(plugin,
...
void sanitizePyrosphereState(Plugin& plugin)
{
...
void applyParam(Plugin& p, clap_id id, double value)
{
    if (id == kPresetParamId) {
        p.presetIndex = std::clamp<uint32_t>(static_cast<uint32_t>(std::lround(value)), 0u, s3g::kAmbiPyrosphereFactoryPresetCount - 1u);
        p.customPresetName[0] = '\0';
        const float outputGainDb = p.params.outputGainDb;
        p.params = s3g::ambiPyrosphereFactoryPreset(p.presetIndex);
...
void applyStateCommand(Plugin& plugin, const StateCommand& command)
{
    ...
    sanitizePyrosphereState(plugin);
    plugin.engine.beginTransition();
    publishControlSnapshot(plugin);
...
clap_process_status process(const clap_plugin_t* plugin, const clap_process_t* proc)
{
    ...
    if (guiIsVisible && p->guiTelemetryCountdown <= frames) {
        ...
        const uint32_t voices = std::min<uint32_t>(
            p->engine.processingVoiceCount(), s3g::kAmbiPyrosphereMaxVoices);
        p->guiVoiceCount.store(voices, std::memory_order_relaxed);
        for (uint32_t voice = 0u; voice < voices; ++voice) {
            const auto point = p->engine.voicePoint(voice);
            p->guiAzimuth[voice].store(point.azimuthDeg, std::memory_order_relaxed);
...
constexpr ParamDef kParams[] {
    { kPresetParamId, "Preset", 0.0, static_cast<double>(s3g::kAmbiPyrosphereFactoryPresetCount - 1u), 0.0, true },
    { kOrderParamId, "Order", 1.0, 7.0, 3.0, true },
    { kVoicesParamId, "Voice Count", 1.0, 64.0, 16.0, true },
    { kRateAParamId, "Heat", 0.0, 1.0, 0.55, false },
    { kRateBParamId, "Ignition Rate",
        s3g::kAmbiPyrosphereMinIgnitionRateHz,
        s3g::kAmbiPyrosphereMaxIgnitionRateHz, 0.08, false },
    { kFmAtoBParamId, "Flare Depth", 0.0, 1.0, 0.48, false },
    { kFmBtoAParamId, "Roar", 0.0, 1.0, 0.36, false },
    { kFlutterParamId, "Flicker", 0.0, 1.0, 0.28, false },
    { kMaterialParamId, "Material Load", 0.0, 1.0, 0.34, false },
    ...
    { kColorParamId, "Flame Color", 0.0, 1.0, 0.48, false },
    { kFilterParamId, "Brittleness", 0.0, 1.0, 0.42, false },
    { kResonanceParamId, "Combustion Detail", 0.0, 1.0, 0.24, false },
    { kFilterRunParamId, "Pyrolysis Body", 0.0, 1.0, 0.52, false },
    { kFilterSweepParamId, "Oxygen", 0.0, 1.0, 0.36, false },
    { kSaturationParamId, "Char", 0.0, 1.0, 0.18, false },
    ...
    { kPlaceParamId, "Place", 0.0, static_cast<double>(s3g::kAmbiPyrospherePlaceCount - 1u), 0.0, true },
    ...
    { kParticlesParamId, "Fragments", 0.0, 1.0, 0.0, false },
    { kVortexParamId, "Plume Vortex", 0.0, 1.0, 0.0, false },
    { kPressureParamId, "Pressure Release", 0.0, 1.0, 0.0, false },
...
const char* paramModule(clap_id id)
{
    ...
    case kDistanceParamId: return "Macro Plume Vector";
    case kPlaceParamId:
    case kSpaceParamId:
...
bool paramsValueToText(const clap_plugin_t*, clap_id id, double value, char* display, uint32_t size)
{
    ...
    if (id == kPresetParamId) {
        std::snprintf(display, size, "%s", s3g::ambiPyrosphereFactoryPresetInfo(static_cast<uint32_t>(std::lround(value))).name);
        ...
        std::snprintf(display, size, "%s", kMaterialNames[std::min<uint32_t>(
            static_cast<uint32_t>(std::lround(value)),
            s3g::kAmbiPyrosphereMaterialCount - 1u)]);
    } else if (id == kPlaceParamId) {
        std::snprintf(display, size, "%s", kPlaceNames[std::min<uint32_t>(
            static_cast<uint32_t>(std::lround(value)), s3g::kAmbiPyrospherePlaceCount - 1u)]);
    ...
    } else if (id == kRateBParamId) {
        if (value < 1.0) {
            std::snprintf(display, size, "%.1f mHz", value * 1000.0);
        } else {
            std::snprintf(display, size, "%.2f Hz", value);
        }
    } else if (id == kRateAParamId) {
...
bool paramsTextToValue(const clap_plugin_t*, clap_id id, const char* display, double* value)
{
    ...
    if (id == kPresetParamId) {
        for (uint32_t index = 0u; index < s3g::kAmbiPyrosphereFactoryPresetCount; ++index) {
            if (std::strcmp(display, s3g::ambiPyrosphereFactoryPresetInfo(index).name) == 0) {
    ...
    if (id == kRateModeBParamId) {
        for (uint32_t index = 0u; index < s3g::kAmbiPyrosphereMaterialCount; ++index) {
    ...
    if (id == kPlaceParamId) {
        for (uint32_t index = 0u; index < s3g::kAmbiPyrospherePlaceCount; ++index) {
    ...
    *value = std::atof(display);
    ...
    if (id == kRateBParamId) {
        ...
        *value = std::clamp(*value,
            static_cast<double>(s3g::kAmbiPyrosphereMinIgnitionRateHz),
            static_cast<double>(s3g::kAmbiPyrosphereMaxIgnitionRateHz));
        return true;
    }
    if (id == kRateAParamId || id == kFmAtoBParamId || id == kFmBtoAParamId
        || id == kFlutterParamId || id == kMaterialParamId || id == kSpreadParamId || id == kDeviationParamId
        || id == kPwmAParamId || id == kPwmBParamId
        || id == kThresholdParamId || id == kColorParamId || id == kFilterParamId || id == kResonanceParamId
        || id == kFilterRunParamId || id == kFilterSweepParamId || id == kSaturationParamId
    ...
    if (version == kStateVersion) {
        ...
        case 17u:
            legacyParamsSize = offsetof(
                s3g::AmbiPyrosphereParams, particles);
            break;
        case 16u:
            legacyParamsSize = offsetof(
                s3g::AmbiPyrosphereParams, fieldListenAmount);
            break;
        case 15u:
            legacyParamsSize = offsetof(
                s3g::AmbiPyrosphereParams, fieldListenMode);
            break;
        case 14u:
            legacyParamsSize = offsetof(
                s3g::AmbiPyrosphereParams, environmentSize);
            break;
        default:
            legacyParamsSize = offsetof(
                s3g::AmbiPyrosphereParams, place);
            break;
        }
        ...
        loaded.presetIndex = std::min<uint32_t>(
            presetIndex, s3g::kAmbiPyrosphereFactoryPresetCount - 1u);
        std::snprintf(loaded.customPresetName,
...
@interface S3GAmbiPyrosphereEncoderView : NSView <NSWindowDelegate> {
    Plugin* _plugin;
    ...
    S3GAmbiPyrosphereEncoderView* _surfacePopupOwner;
    NSPanel* _surfacePanel;
    S3GAmbiPyrosphereEncoderView* _surfacePopupView;
...
@implementation S3GAmbiPyrosphereEncoderView
- (instancetype)initWithPlugin:(Plugin*)plugin
{
...
- (void)openSurfacePopup
{
    ...
    if (!_surfacePanel) {
        ...
        [_surfacePanel setTitle:@"s3g AMBI ENCODER PYROSPHERE — SURF"];
        [_surfacePanel setReleasedWhenClosed:NO];
        [_surfacePanel setHidesOnDeactivate:YES];
        [_surfacePanel setDelegate:self];
        _surfacePopupView = [[S3GAmbiPyrosphereEncoderView alloc]
...
{
    if (!_plugin || voice >= s3g::kAmbiPyrosphereMaxVoices) return { 0.0f, 0.0f, 0.0f };
...
{
    return [NSHomeDirectory() stringByAppendingPathComponent:@"Music/s3g/Presets/Ambi Pyrosphere Encoder"];
}
...
- (void)saveCustomPreset
{
    ...
    [panel setAllowedFileTypes:@[ @"s3gpyro" ]];
    [panel setNameFieldStringValue:[NSString stringWithFormat:@"%@.s3gpyro", [self presetDisplayName]]];
...
- (void)loadCustomPreset
{
    ...
    [panel setDirectoryURL:[NSURL fileURLWithPath:directory isDirectory:YES]];
    // Accept the pre-rename extension so saved Fire presets remain importable.
    [panel setAllowedFileTypes:@[ @"s3gpyro" ]];
...
- (void)drawField:(NSDictionary*)attrs valueAttrs:(NSDictionary*)valueAttrs style:(const s3g::clap_gui::Style&)style
{
    ...
    s3g::clap_gui::drawPanelHeader(@"PYROSPHERE GEO FIELD", true, panel.origin.x, panel.origin.y, panel.size.width, 21, attrs, style);
    ...
    s3g::clap_gui::drawToolboxHeaderButton([self pageButtonRect:1], header, @"SURF", _fieldPage == 1, attrs, style);
    if (_fieldPage == 1) {
    ...
    std::array<NSPoint, s3g::kAmbiPyrosphereMaxVoices> projected {};
    ...
    [@"HEAT / FRACTURE FIELD     MATERIAL FAILURE + PLUME     ACN/SN3D" drawAtPoint:NSMakePoint(field.origin.x + 9, NSMaxY(field) - 19) withAttributes:valueAttrs];
}
...
- (void)drawPanels:(NSDictionary*)attrs valueAttrs:(NSDictionary*)valueAttrs style:(const s3g::clap_gui::Style&)style
{
    ...
    s3g::clap_gui::drawPanelHeader(@"SOURCE / PYROSPHERE", true, 630, 134, 250, 21, attrs, style);
    [self drawSlider:@"PLUME WANDER" param:kRateModeAParamId value:p.vectorRateHz attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawMenu:@"MATERIAL" value:[NSString stringWithUTF8String:
        kMaterialNames[std::min<uint32_t>(p.materialMode,
            s3g::kAmbiPyrosphereMaterialCount - 1u)]] panelX:630 y:222
        attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"VOICES" param:kVoicesParamId value:p.voices attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"HEAT" param:kRateAParamId value:p.wind attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"IGNITION RATE" param:kRateBParamId value:p.gustRate attrs:attrs valueAttrs:valueAttrs style:style];
    ...
    s3g::clap_gui::drawPanelHeader(@"COMBUSTION DYNAMICS", true, 630, 356, 250, 21, attrs, style);
    static constexpr const char* kEdgeNames[] = { "SOFT", "BEND", "HARD" };
    [self drawMenu:@"IGNITION EDGE" value:[NSString stringWithUTF8String:kEdgeNames[std::min<uint32_t>(p.gustEdge, 2u)]] panelX:630 y:392 attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"FLARE DEPTH" param:kFmAtoBParamId value:p.gustDepth attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"ROAR" param:kFmBtoAParamId value:p.turbulence attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"FLICKER" param:kFlutterParamId value:p.flutter attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"MATERIAL LOAD" param:kMaterialParamId value:p.material attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"FLAME SHAPE" param:kGustShapeParamId value:p.gustShape attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"BURN CORE" param:kThresholdParamId value:p.center attrs:attrs valueAttrs:valueAttrs style:style];

    s3g::clap_gui::drawPanelFrame(630, 578, 250, 236, style);
    s3g::clap_gui::drawPanelHeader(@"AIR / MATERIAL RESPONSE", true, 630, 578, 250, 21, attrs, style);
    ...
    [self drawSlider:@"FLAME COLOR" param:kColorParamId value:p.sweep attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"BRITTLENESS" param:kFilterParamId value:p.q attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"COMB DETAIL" param:kResonanceParamId value:p.shrill attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"PYROLYSIS" param:kFilterRunParamId value:p.body attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"OXYGEN" param:kFilterSweepParamId value:p.breath attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"CHAR" param:kSaturationParamId value:p.grit attrs:attrs valueAttrs:valueAttrs style:style];

    s3g::clap_gui::drawPanelFrame(896, 42, 246, 210, style);
    s3g::clap_gui::drawPanelHeader(@"THERMAL TRANSPORT", true, 896, 42, 246, 21, attrs, style);
    ...
    s3g::clap_gui::drawPanelHeader(@"PROJECTION / PLUME VECTOR", true, 896, 264, 246, 21, attrs, style);
    ...
    [self drawMenu:@"PLACE" value:[NSString stringWithUTF8String:kPlaceNames[
        std::min<uint32_t>(p.place, s3g::kAmbiPyrospherePlaceCount - 1u)]] panelX:896 y:418 attrs:attrs valueAttrs:valueAttrs style:style];
    ...
    s3g::clap_gui::drawPanelFrame(896, 630, 246, 184, style);
    s3g::clap_gui::drawPanelHeader(@"STRUCTURAL CONSEQUENCES", true,
        896, 630, 246, 21, attrs, style);
    [self drawSlider:@"FRAGMENTS" param:kParticlesParamId value:p.particles
        attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"PLUME VORTEX" param:kVortexParamId value:p.vortex
        attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"PRESSURE" param:kPressureParamId value:p.pressure
        attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"STRUCT LOAD" param:kStructuralLoadParamId
        value:p.structuralLoad attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"BRANCH SNAP" param:kSnapParamId value:p.snap
        attrs:attrs valueAttrs:valueAttrs style:style];
    [self drawSlider:@"TREE FALL" param:kFallParamId value:p.fall
        attrs:attrs valueAttrs:valueAttrs style:style];
}
...
{
    switch (menu) {
    case 1: return s3g::kAmbiPyrosphereFactoryPresetCount;
    case 2: return 0u;
    case 3: return s3g::kAmbiPyrosphereMaterialCount;
    case 4: return s3g::kAmbiPyrospherePlaceCount;
    case 5: return 4u;
    case 6: return 4u;
    case 7: return 0u;
    case 8: return 0u;
...
- (void)drawOpenMenu:(NSDictionary*)attrs style:(const s3g::clap_gui::Style&)style
{
    ...
    static NSString* presetItems[s3g::kAmbiPyrosphereFactoryPresetCount];
    static dispatch_once_t once;
    dispatch_once(&once, ^{
        for (uint32_t i = 0; i < s3g::kAmbiPyrosphereFactoryPresetCount; ++i) presetItems[i] = [[NSString stringWithUTF8String:s3g::ambiPyrosphereFactoryPresetInfo(i).name] retain];
    });
...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    [@"s3g AMBI ENCODER PYROSPHERE" drawAtPoint:NSMakePoint(18, 14) withAttributes:titleAttrs];
        ...
        if (hit >= 0) {
            ...
            if (param != CLAP_INVALID_ID) {
                if (param == kPresetParamId) {
                    ...
                    _paramsSnapshot = s3g::ambiPyrosphereFactoryPreset(
...
bool guiCreate(const clap_plugin_t* plugin, const char* api, bool isFloating)
{
    ...
    p->guiView = [[S3GAmbiPyrosphereEncoderView alloc] initWithPlugin:p];
...
void guiDestroy(const clap_plugin_t* plugin)
{
    auto* p = self(plugin);
    if (!p->guiView) return;
    [static_cast<S3GAmbiPyrosphereEncoderView*>(p->guiView) destroySurfacePopup];
    [static_cast<S3GAmbiPyrosphereEncoderView*>(p->guiView) stopRefreshTimer];
    s3g::clap_gui::destroyResponsiveViewport(p->guiViewport, p->guiView);
...
bool guiShow(const clap_plugin_t* plugin) { auto* p = self(plugin); if (!p->guiView || !s3g::clap_gui::setResponsiveViewportHidden(p->guiViewport, false)) return false; p->guiVisible.store(true, std::memory_order_release); [static_cast<S3GAmbiPyrosphereEncoderView*>(p->guiView) startRefreshTimer]; return true; }
bool guiHide(const clap_plugin_t* plugin) { auto* p = self(plugin); if (!p->guiView) return false; p->guiVisible.store(false, std::memory_order_release); [static_cast<S3GAmbiPyrosphereEncoderView*>(p->guiView) hideSurfacePopup]; [static_cast<S3GAmbiPyrosphereEncoderView*>(p->guiView) stopRefreshTimer]; return s3g::clap_gui::setResponsiveViewportHidden(p->guiViewport, true); }
...
#if defined(S3G_ENABLE_VSTGUI_CANVAS_GUI)
#include "../common/s3g_environment_encoder_pyrosphere_canvas.inc"
#endif
...
const clap_plugin_descriptor_t descriptor {
    ...
    "",
    "0.3.0",
    "Procedural 7OA combustion instrument modeling fuel-specific pyrolysis, roar, flicker, crackle, embers, backdraft, and rising plume motion.",
    features
};
...
const clap_plugin_t* create(const clap_host_t* host)
{
    ...
    if (!p) return nullptr;
    p->host = host;
    p->params = s3g::ambiPyrosphereFactoryPreset(0u);
