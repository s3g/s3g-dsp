...
#include "renderer/metal_shader.h"
#include "renderer/energy_gpu.h"
...
using EnergyGpuParams = s3g::energy::Params;
static_assert(kEnergyMapCols == s3g::energy::columns && kEnergyMapRows == s3g::energy::rows);
static_assert(kChannelCount == s3g::energy::channels && kEnergyGpuSnapshotCount == s3g::energy::snapshotLimit);
...
- (id)initWithFrame:(NSRect)frame
{
    ...
    if (self) {
        ...
        if (_device) {
            ...
            NSString* shaderSource = [NSString stringWithUTF8String:s3g::energy::metalShader];
            NSError* error = nil;
