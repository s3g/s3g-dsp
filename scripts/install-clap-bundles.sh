...
copy_bundle "$src_root/clap_ambi_neural_ecology/s3g_ambi_neural_ecology.clap"
...
copy_bundle "$src_root/clap_ambi_wind_encoder/s3g_ambi_wind_encoder.clap"
copy_bundle "$src_root/clap_ambi_water_encoder/s3g_ambi_water_encoder.clap"
copy_bundle "$src_root/clap_ambi_pyrosphere_encoder/s3g_ambi_pyrosphere_encoder.clap"
copy_bundle "$src_root/clap_ambi_cryosphere_encoder/s3g_ambi_cryosphere_encoder.clap"
copy_bundle "$src_root/clap_ambi_insect_encoder/s3g_ambi_insect_encoder.clap"
copy_bundle "$src_root/clap_accelerometer_field_encoder/s3g_accelerometer_field_encoder.clap"
copy_bundle "$src_root/clap_ambi_imprint/s3g_ambi_imprint.clap"
copy_bundle "$src_root/clap_ambi_ray_encoder/s3g_ambi_ray_encoder.clap"
copy_bundle "$src_root/clap_ambi_ray_bilocation_encoder/s3g_ambi_ray_bilocation_encoder.clap"
...
copy_bundle "$src_root/clap_dbap_panner/s3g_dbap_panner.clap"
copy_bundle "$src_root/clap_lbap_panner/s3g_lbap_panner.clap"
copy_bundle "$src_root/clap_vbap_panner/s3g_vbap_panner.clap"
...
copy_bundle "$src_root/clap_psd_raw_field/s3g_fault.clap"
...
copy_bundle "$src_root/clap_macro_shred/s3g_macro_shred_mono.clap"
copy_bundle "$src_root/clap_macro_shred/s3g_macro_shred.clap"
copy_bundle "$src_root/clap_macro_shred/s3g_24ch_macro_shred.clap"
...
copy_bundle "$src_root/clap_array_delay/s3g_array_delay_16.clap"
copy_bundle "$src_root/clap_array_delay/s3g_array_delay_26.clap"
copy_bundle "$src_root/clap_array_delay/s3g_array_delay_32.clap"
copy_bundle "$src_root/clap_array_delay/s3g_array_delay_64.clap"
copy_bundle "$src_root/clap_array_trim/s3g_array_trim_16.clap"
copy_bundle "$src_root/clap_array_trim/s3g_array_trim_26.clap"
copy_bundle "$src_root/clap_array_trim/s3g_array_trim_32.clap"
copy_bundle "$src_root/clap_array_trim/s3g_array_trim_64.clap"
copy_bundle "$src_root/clap_ambisonic_rotate/s3g_ambisonic_rotate.clap"
copy_bundle "$src_root/clap_ambi_effect_dj_filter/s3g_ambi_effect_dj_filter.clap"
copy_bundle "$src_root/clap_ambi_effect_delay/s3g_ambi_effect_delay.clap"
copy_bundle "$src_root/clap_ambi_effect_pitch_gain/s3g_ambi_effect_pitch.clap"
copy_bundle "$src_root/clap_ambi_effect_pitch_gain/s3g_ambi_effect_gain.clap"
