...
remove_stale_bundle "s3g_modal_encoder.clap"
remove_stale_bundle "s3g_ambi_modal_encoder.clap"
...
copy_bundle "$src_root/clap_ambi_point_encoder/s3g_ambi_point_encoder.clap"
...
copy_bundle "$src_root/clap_accelerometer_field_encoder/s3g_ambi_encoder_modal.clap"
...
copy_bundle "$src_root/clap_ambi_speaker_decoder/s3g_ambi_speaker_decoder.clap"
...
copy_bundle "$src_root/clap_ambi_effect_displacement/s3g_ambi_effect_displacement.clap"
