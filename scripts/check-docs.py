...
EXPECTED_SHARED_TOC_LINKS = {
    ...
    "Decoder Pages": [
        ...
        "ambi-decoder-object.html",
        "ambi-decoder-adaptive.html",
        "ambi-decoder-sub.html",
...
DOC_SEQUENCE = [
    ...
    "processor-lowform.html",
    "processor-stack.html",
    "processor-conduit.html",
    "processor-feedback-shift.html",
